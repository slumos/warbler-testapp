...
Warbler::Traits.module_eval do
  def auto_detect_traits
    [Warbler::Traits::Bundler, Warbler::Traits::Jar, Warbler::Traits::NoGemspec]
  end
end
...
Warbler::Config.new do |config|
  ...
  config.dirs = %w(app bin config lib log vendor tmp)
  ...
  config.excludes = FileList['testapp.jar', 'Gemfile*']
